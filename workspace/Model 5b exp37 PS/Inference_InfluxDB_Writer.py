# Inference_InfluxDB_Writer.py — Model 5b Experiment 37 (Palm Springs)
# INT8-quantized Conv2D model compiled for Edge TPU.
# New vs previous inference scripts: adds temp_lag180 feature (Exp 37).
# Uses Palm Springs weather data (ps_smartweather database).
...
parser = argparse.ArgumentParser(description="Run Model 5b Exp 37 PS inference and write results to InfluxDB.")
parser.add_argument(
    "--tpu",
    default="",
...
# Fill features that are entirely NaN with their scaler midpoint (handles PS stations
# that may not publish certain fields).
