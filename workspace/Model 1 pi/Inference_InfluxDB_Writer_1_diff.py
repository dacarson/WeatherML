...
FEATURE_ORDER = [
    ...
    'day_of_year', 'time_of_day_sin', 'time_of_day_cos', 'temperature_delta', 'pressure_delta', 'humidity_delta', 
...
# Add cyclical encoding for time_of_day to better capture daily patterns
...
if drop_measurements:
    ...
    try:
        client.query('DROP MEASUREMENT "model_1_diff"')
