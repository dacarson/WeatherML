def main():
    ...
    def build_and_train_model(name):
        ...
        tflite_fname = f"weather_model_1_diff_quant_{name}.tflite"
        ...
        with open(f"results_diff_{name}.json", "w") as f:
    ...
    for run_id in range(NUM_RUNS):
        json_file = f"results_diff_dense_wide_run{run_id+1}.json"
    ...
    import shutil
    best_model_file = f"weather_model_1_diff_quant_{best['name']}.tflite"
    shutil.copy(best_model_file, "weather_model_1_diff_best.tflite")
