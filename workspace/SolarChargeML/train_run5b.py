"""Run 5b: asymmetric (quantile) loss sweep, same extended dataset/features/hyperparams as
Run 5a. quantile<0.5 biases the model to under-predict excess (the cheaper NEM 3.0 failure
mode); quantile=0.5 is also informative on its own (pinball loss at the median vs. Run
4/5a's squared_error). See SOLARCHARGE_EXPERIMENT_LOG.md Run 5b for the full hypothesis."""
...
for quantile in (0.3, 0.4, 0.5):
    ...
    path = f"model_run5b_{q_tag}.joblib"
